const proxyCors='https://cors-anywhere.herokuapp.com/';
	...
	(function(){
		...
		var list  = [
		      ...
		      i;
		      const icons={
		      	"clear-day":"./js/icons/001lighticons-01.png",
		      	"clear-night":"./js/icons/001lighticons-02.png",
		      	"partly-cloudy-day":"./js/icons/001lighticons-08.png",
		      	"partly-cloudy-night":"./js/icons/001lighticons-09.png",
		      	"cloudy":"./js/icons/001lighticons-25.png",
		      	"rain":"./js/icons/001lighticons-18.png",
		      	"sleet":"./js/icons/001lighticons-23.png",
		      	"snow":"./js/icons/001lighticons-24.png",
		      	"wind":"./js/icons/001lighticons-06.png",
		      	"fog":"./js/icons/001lighticons-13.png"
		      };
